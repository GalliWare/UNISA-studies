...
int main()
{
  ...
  //must be correspond with the //number of names and prices
  string names[] = {"Plain candles", "Scented candles", "Dream-catchers", "Bead place mats", "Bead coasters", "Incense holders", "Hand-painted Ms"};
